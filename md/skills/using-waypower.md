...
> The always-active orchestrator — mandatory skill invocation, priority ladder, and red-flag rules.
> Source: https://mohmaedeslam00116.github.io/waypower-docs/docs/skills/using-waypower

<SkillSpec n="01" type="orchestrator" invocation="always active" trigger="Every incoming task — before anything else is allowed to start" output="The right skill, routed — with the red-flag rules enforced" pairs={['design-interview', 'completion-gate']} />
