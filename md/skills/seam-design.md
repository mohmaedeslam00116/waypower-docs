...
> Shared vocabulary for deep modules — where interfaces go, how to make code testable and AI-navigable.
> Source: https://mohmaedeslam00116.github.io/waypower-docs/docs/skills/seam-design

<SkillSpec n="04" type="process" invocation="auto-invoked" trigger="An interface or module seam is being shaped" output="Deep-module contracts before implementation" pairs={['seam-driven-tdd']} />
