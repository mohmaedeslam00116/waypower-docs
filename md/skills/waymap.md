...
> Chart huge, foggy efforts into a map of decision tickets on the issue tracker — then resolve them one at a time.
> Source: https://mohmaedeslam00116.github.io/waypower-docs/docs/skills/waymap

<SkillSpec n="10" type="tool" invocation="on-call" trigger='"waymap this" — an effort too big to see whole' output="A decision map of tickets, resolved one at a time" pairs={['tracer-plan']} />
